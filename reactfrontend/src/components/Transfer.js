...
import '../styles/transfer.css'; // Ensure you have corresponding styles for Transfer

function Transfer({ onClose }) {
  // Static account balances
  const [accounts] = useState({
    checking: { balance: 2000, id: 1 }, // Example balance for checking account
    savings: { balance: 5000, id: 2 },   // Example balance for savings account
  ...
  const handleSubmit = event => {
    ...
    // Here you can add logic to update the balances if needed
        ...
        <form onSubmit={handleSubmit}>
          <label>
            ...
            <select value={fromAccount} onChange={e => setFromAccount(e.target.value)}>
              ...
              <option value="checking">Checking (${accounts.checking.balance.toLocaleString()})</option>
              <option value="savings">Savings (${accounts.savings.balance.toLocaleString()})</option>
              <option value="moneyMarket">Money Market (${accounts.moneyMarket.balance.toLocaleString()})</option>
            </select>
          </label>
          <label>
            To:
