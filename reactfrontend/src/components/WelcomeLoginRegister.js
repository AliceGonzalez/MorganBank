...
const WelcomeLoginRegister = ({ loginRef }) => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Directly navigate to accounts page
    navigate('/accounts');
  };
        ...
        {isLogin ? (
          <>
            ...
            <form className="login-form" onSubmit={handleLogin}>
              <input className="input-field" type="text" name="username" required placeholder="Username" />
              <input className="input-field" type="password" name="password" required placeholder="Password" />
              <button className="cs-button-solid" type="submit">Login</button>
              <button className="cs-button-solid" onClick={toggleForm} type="button">Sign Up</button>
            </form>
          </>
        ) : (
